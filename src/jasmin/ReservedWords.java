...
abstract class ReservedWords {
	...
	reserved_words.put(".class_attribute", new token(sym.DCLASS_ATTR));	
reserved_words.put(".field_attribute", new token(sym.DFIELD_ATTR));
       reserved_words.put(".method_attribute", new token(sym.DMETHOD_ATTR));
       reserved_words.put(".code_attribute", new token(sym.DCODE_ATTR));
